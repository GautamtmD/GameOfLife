 ...
 * 
 *    If only one value is provided it is taken as a 
 *    gray scale color.
 *    eg:
 *     fill(255) -> white color
 *     fill(0) -> black color
 * 
 *    If two values are provided first is taken as grayscale
 *    color and second is taken as alpha value
 *  
 *   A p5 Color object can also be provided to set the 
 *   fill color.
 *
 ...
 *   b, c, d, start, and stop, the arc will be drawn 
